        ...
        <ul className='navbar-nav ml-auto'>
          ...
          <li className='nav-item dropdown no-arrow mx-1'>
            <a
              ...
              data-toggle='dropdown'
              aria-haspopup='true'
              aria-expanded={isAlertDropdown ?? 'true'}
              onClick={() => setIsAlertDropdown(!isAlertDropdown)}
            >
          ...
          >
            <a
              ...
              data-toggle='dropdown'
              aria-haspopup='true'
              aria-expanded={isShowMessageDropdown ?? 'true'}
              onClick={() => setIsShowMessageDropdown(!isShowMessageDropdown)}
            >
          ...
          >
            <a
              ...
              data-toggle='dropdown'
              aria-haspopup='true'
              aria-expanded={isShowProfileDropdown ?? 'true'}
